...
PrepareERA<-function(Data,
                    ...
                    Invert2xNeg=T,
                    PLevel="Practice",
                    Cols = c("Code","Country","Latitude","Longitude","Buffer","Site.Type","ID","Site.ID","Rep","Diversity","Tree","Variety","Duration","M.Year","EU","EUlist",
                             ...
                             "Theme.Code","PrName.Base.Code","SubPrName.Base.Code","Theme.Base.Code","Partial.Outcome.Name","Partial.Outcome.Code","AEZ16simple"),
                     OutcomeCodes,
                     PracticeCodes,
                     EUCodes
){
